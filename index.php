...
<body>
    <header>
        <div>
            <img src="./imgs/googlelogo_clr_74x24px.svg" alt="Google Logo">
    ...
    <footer>
        <div class="container">
            ...
            <select name="language" id="languange">
                <option value="it">italiano</option>
                <option value="us">inglese US</option>
            </select>
        </div>
    </footer>
</body>
